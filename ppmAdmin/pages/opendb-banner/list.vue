<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" collection="opendb-banner" field="fileinfo,open_url,title,sort,category_id,status,description" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          ...
          <uni-tr v-for="(item,index) in data" :key="index">
            ...
            <uni-td align="center">
                  <!-- <pre>{{item}}</pre> -->
                  <image  v-if="item.fileinfo && item.fileinfo.fileType == 'image'"  :src="item.fileinfo.url" mode="" style="width: 250px;height: 142px;border-radius: 3px;"></image>
<!--             <uni-file-picker v-if="item.fileinfo && item.fileinfo.fileType == 'image'" :value="item.fileinfo" :file-mediatype="item.fileinfo && item.fileinfo.fileType" return-type="object" :imageStyles="imageStyles" readonly></uni-file-picker> -->
              <uni-link v-else :href="item.fileinfo && item.fileinfo.url" :text="item.fileinfo && item.fileinfo.url">Image link</uni-link>
            </uni-td>
            <uni-td align="center">
