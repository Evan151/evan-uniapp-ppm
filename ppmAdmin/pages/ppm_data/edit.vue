  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("title,category_id,content,b_mode,price,vip_price,avatar,store_link,pass_code,article_status,publish_date").get().then((res) => {
